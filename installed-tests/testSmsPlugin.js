...
describe('The sms plugin', function () {
    ...
    it('can be loaded', async function () {
        ...
        remotePlugin = testRig.remoteDevice._plugins.get('sms');
    ...
    it('enables its GActions when connected', function () {
        ...
        for (let action in localPlugin._meta.actions)
            expect(localPlugin.device.get_action_enabled(action)).toBe(true);
    });
    ...
    it('disables its GActions when disconnected', function () {
        ...
        for (let action in localPlugin._meta.actions)
            expect(localPlugin.device.get_action_enabled(action)).toBe(false);
    });
});
